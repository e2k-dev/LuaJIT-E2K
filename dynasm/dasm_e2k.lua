...
local rreg_list = {}    -- Directly addressable registers of the current window
local breg_list = {}    -- Rotating registers of the current window
...
local ctpr_list = {}    -- Control transer preparation registers
local greg_list = {}    -- Global registers
...
local map_op = {
  ...
  cmpedbsm_5 = "ALU2PR_ALOPF7_1_0x1b_0x21_0x2",
